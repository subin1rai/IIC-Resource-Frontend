...
const Vendor = () => {
  ...
  const customStyles = {
    control: (provided, state) => ({
      ...
      padding: "0.25rem 0.5rem", // Padding to match `p-2` (which is equivalent to `0.5rem`)
      width: "100%", // Set width to 100% for flexibility, container will control final width
      boxShadow: "none", // No box shadow
      "&:hover": {
        border: state.isFocused ? "2px solid #94a3b8" : "2px solid #D1D5DB", // Prevents border change on hover
      },
    }),
    menu: (provided) => ({
      ...provided,
      width: "100%", // Matches the width of the control
    }),
    container: (provided) => ({
      ...provided,
      width: "250px", // Matches the width specified in the className
    }),
    menuPortal: (provided) => ({
      ...provided,
      zIndex: 9999,
          ...
          >
            ...
            <div className="flex gap-8">
              ...
              <div className="flex flex-col gap-3">
                ...
                <Select
                  options={itemFilterCategoryOptions}
                  onChange={(selectedOption) =>
                    setFilterOptions((prev) => ({
                      ...prev,
