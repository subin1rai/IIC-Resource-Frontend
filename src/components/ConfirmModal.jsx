...
const ConfirmModal = ({ show, onClose, onConfirm }) => {
  ...
  return (
    <div className="fixed inset-0 bg-overlay bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-lg w-[27%] h-[25%] text-center">
        ...
        <div className="flex justify-around mt-8 w-[100%]">
          <button 
            className="bg-blue-600 w-[27%] text-white text-lg py-2 px-4 rounded"
            onClick={onConfirm}
          >
            Yes
          </button>
          <button 
            className="bg-red-500 w-[27%] text-white py-2 text-lg px-4 rounded"
            onClick={onClose}
          >
            No
          </button>
